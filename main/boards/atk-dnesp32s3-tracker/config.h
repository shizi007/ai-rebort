...
/* ============ 舵机引脚配置（新增） ============ */
/* 使用空闲GPIO，与摄像头/I2S/LCD/LED均无冲突 */
#define PAN_SERVO_GPIO          GPIO_NUM_2    // 水平舵机 (Pan)
#define TILT_SERVO_GPIO         GPIO_NUM_8    // 俯仰舵机 (Tilt)

#define PAN_SERVO_LEDC_CHANNEL  LEDC_CHANNEL_1
#define TILT_SERVO_LEDC_CHANNEL LEDC_CHANNEL_2
#define SERVO_LEDC_TIMER        LEDC_TIMER_1  // 独立于 TIMER_0

#define SERVO_PWM_FREQ          50            // 50Hz，SG90 标准
#define SERVO_PWM_RESOLUTION    LEDC_TIMER_14_BIT

#define SERVO_MIN_ANGLE         0
#define SERVO_MAX_ANGLE         180
#define SERVO_CENTER_ANGLE      90            // 居中位置
